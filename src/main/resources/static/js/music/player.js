...
class Musics {
    ...
    constructor() {
        this.songs = [{
                id: 1,
                title: 'Cheap Talk - PushPlay',
                singer: 'Cheap Talk',
                songUrl: './songs/pushplay.mp3',
                imageUrl: './img/songs/pushplay.png'
            },
            {
                id: 2,
                title: 'Dido - Stan(feat. Eminem)',
                singer: 'Dido(feat. Eminem)',
                songUrl: './songs/stan.mp3',
                imageUrl: './img/songs/stan.png'
            },
            {
                id: 3,
                title: 'Campsite Dream - Driving Home for Christmas',
                singer: 'Campsite Dream',
                songUrl: './songs/christmas.mp3',
                imageUrl: './img/songs/christmas.jpg'
            }
        ]
    }
    //根据索引获取歌曲的方法
